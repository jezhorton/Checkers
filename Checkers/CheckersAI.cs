...
namespace CheckersBoard
{
    class CheckersAI
    {
        ...
        public static Move GetMoveBlack(CheckerBoard currentBoard)
        {
            List<Move> avaliableMoves = GetAvaliableMovesBlack(currentBoard);
            avaliableMoves.Shuffle();
            if (avaliableMoves.Count < 1)
                return null;
            return avaliableMoves[0];
        ...
        private static List<Move> GetAvaliableMovesBlack(CheckerBoard currentBoard)
        {
            List<Piece> currentPieces = new List<Piece>();
            List<Move> avaliableMoves = new List<Move>();
